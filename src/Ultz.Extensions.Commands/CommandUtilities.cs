...
namespace Ultz.Extensions.Commands
{
    ...
    public static class CommandUtilities
    {
        ...
        static CommandUtilities()
        {
            ...
            FriendlyPrimitiveTypeNames = new ReadOnlyDictionary<Type, string>(
                new Dictionary<Type, string>(PrimitiveTypeParserCount)
                {
                    [typeof(char)] = "char",
                    [typeof(bool)] = "bool",
                    [typeof(byte)] = "byte",
        ...
        public static bool HasPrefix(string input, char prefix, out string output)
        {
            return HasPrefix(
                input != null
                    ? input.AsSpan()
                    : throw new ArgumentNullException(nameof(input), "The input must not be null."), prefix, false,
                out output);
        }
        ...
        /// If it does, returns <see langword="true" />, the found <paramref name="prefix" />, and the trimmed
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(string input, IReadOnlyList<char> prefixes, bool isCaseSensitive,
            out char prefix, out string output)
        {
            if (input == null)
            {
                throw new ArgumentNullException(nameof(input), "The input must not be null.");
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(string input, IEnumerable<char> prefixes, bool isCaseSensitive, out char prefix,
            out string output)
        {
            if (input == null)
            {
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(string input, IReadOnlyList<string> prefixes, out string prefix,
            out string output)
        {
            if (input == null)
            {
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(string input, IReadOnlyList<string> prefixes, StringComparison comparison,
            out string prefix, out string output)
        {
            if (input == null)
            {
                throw new ArgumentNullException(nameof(input), "The input must not be null.");
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(string input, IEnumerable<string> prefixes, out string prefix,
            out string output)
        {
            return HasAnyPrefix(input.AsSpan(), prefixes, StringComparison.Ordinal, out prefix, out output);
        }
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(string input, IEnumerable<string> prefixes, StringComparison comparison,
            out string prefix, out string output)
        {
            if (input == null)
            {
        ...
        {
            return HasPrefix(input, prefix, false, out output);
        }
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(ReadOnlySpan<char> input, IReadOnlyList<char> prefixes, out char prefix,
            out string output)
        {
            return HasAnyPrefix(input, prefixes, false, out prefix, out output);
        }
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(ReadOnlySpan<char> input, IReadOnlyList<char> prefixes, bool isCaseSensitive,
            out char prefix, out string output)
        {
            if (prefixes == null)
            {
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(ReadOnlySpan<char> input, IEnumerable<char> prefixes, out char prefix,
            out string output)
        {
            return HasAnyPrefix(input, prefixes, false, out prefix, out output);
        }
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(ReadOnlySpan<char> input, IEnumerable<char> prefixes, bool isCaseSensitive,
            out char prefix, out string output)
        {
            if (prefixes == null)
            {
        ...
        {
            return HasPrefix(input, prefix, StringComparison.Ordinal, out output);
        }
        ...
        /// The prefix must not be null.
        /// </exception>
        public static bool HasPrefix(ReadOnlySpan<char> input, string prefix, StringComparison comparison,
            out string output)
        {
            if (prefix == null)
            {
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(ReadOnlySpan<char> input, IReadOnlyList<string> prefixes, out string prefix,
            out string output)
        {
            return HasAnyPrefix(input, prefixes, StringComparison.Ordinal, out prefix, out output);
        }
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(ReadOnlySpan<char> input, IReadOnlyList<string> prefixes,
            StringComparison comparison, out string prefix, out string output)
        {
            if (prefixes == null)
            {
                throw new ArgumentNullException(nameof(prefixes), "The prefixes must not be null.");
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(ReadOnlySpan<char> input, IEnumerable<string> prefixes, out string prefix,
            out string output)
        {
            return HasAnyPrefix(input, prefixes, StringComparison.Ordinal, out prefix, out output);
        }
        ...
        /// The prefixes must not be null.
        /// </exception>
        public static bool HasAnyPrefix(ReadOnlySpan<char> input, IEnumerable<string> prefixes,
            StringComparison comparison, out string prefix, out string output)
        {
            if (prefixes == null)
            {
        ...
        /// <summary>
        /// Recursively enumerates all of the <see cref="CommandBuilder" />s in the provided <see cref="ModuleBuilder" /> and its
        /// submodules.
        /// </summary>
        /// <returns>
