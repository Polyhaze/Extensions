...
namespace Ultz.Extensions.Commands.Builders
{
    ...
    public sealed class CommandBuilder
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="Commands.RunMode" /> of the <see cref="Command" />.
        /// </summary>
        ...
        /// </summary>
        public List<Cooldown.Cooldown> Cooldowns { get; }
        ...
        /// </summary>
        public CommandBuilder AddCooldown(Cooldown.Cooldown cooldown)
        {
        ...
        internal Command Build(Module module)
        {
            ...
            {
                throw new CommandBuildingException(this,
            ...
            for (var i = 0; i < Parameters.Count; i++)
            {
                ...
                {
                    throw new CommandBuildingException(this,
                        "Optional parameters must not appear before required ones.");
                }
