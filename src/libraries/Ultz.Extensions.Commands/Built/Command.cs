    ...
    public sealed class Command
    {
        ...
        internal Command(CommandBuilder builder, Module module)
        {
            ...
            if (Cooldowns.Count != 0)
            {
                ...
                {
                    throw new CommandBuildingException(builder,
                        "Cooldown bucket key generator delegate has not been set.");
                }
        ...
        /// <summary>
        /// Gets the <see cref="Commands.RunMode" /> of this <see cref="Command" />.
        /// </summary>
        ...
        /// </summary>
        public IReadOnlyList<Cooldown.Cooldown> Cooldowns { get; }
        ...
        /// </summary>
        /// <remarks>
        /// Aliases of parent <see cref="Built.Module" />s and this <see cref="Command" />
        ...
        /// <summary>
        /// Gets the <see cref="Built.Module" /> of this <see cref="Command" />.
        /// </summary>
        ...
        /// <summary>
        /// Runs checks on parent <see cref="Built.Module" />s and this <see cref="Command" />.
        /// </summary>
        ...
        /// <summary>
        /// Resets the <see cref="Cooldown" /> bucket with a key generated from the provided <see cref="CommandContext" /> on this
        /// <see cref="Command" />.
        /// </summary>
        ...
        public void ResetCooldown(Cooldown.Cooldown cooldown, CommandContext context)
        {
            if (CooldownMap == null)
            {
                return;
        ...
        public IResult RunCooldowns(CommandContext context)
        {
            if (CooldownMap != null)
            {
                ...
                var rateLimited = ImmutableArray.CreateBuilder<(Cooldown.Cooldown, TimeSpan)>(buckets.Length);
        ...
        {
            return Service.ExecuteAsync(this, rawArguments, context);
        }
        ...
        {
            return Service.ExecuteAsync(this, arguments, context);
        }
